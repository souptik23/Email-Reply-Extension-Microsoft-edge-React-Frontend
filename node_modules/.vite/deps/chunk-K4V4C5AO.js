...
var SvgIcon = React41.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React41.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React50.useState(false);
...
true ? Ripple.propTypes = {
   ...
   */
  pulsate: import_prop_types30.default.bool,
  /**
   * Diameter of the ripple.
   */
  rippleSize: import_prop_types30.default.number,
  /**
   * Horizontal position of the ripple center.
   */
  rippleX: import_prop_types30.default.number,
  /**
   * Vertical position of the ripple center.
   */
  rippleY: import_prop_types30.default.number,
  /**
   * exit delay
   */
  timeout: import_prop_types30.default.number.isRequired
} : void 0;
...
`;
var TouchRipple = React51.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const [ripples, setRipples] = React51.useState([]);
  const nextKey = React51.useRef(0);
  const rippleCallback = React51.useRef(null);
  React51.useEffect(() => {
  ...
  const ignoringMouseDown = React51.useRef(false);
  const startTimer = useTimeout();
  const startTimerCommit = React51.useRef(null);
  const container = React51.useRef(null);
  const startCommit = React51.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start = React51.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React51.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React51.useCallback((event, cb) => {
    startTimer.clear();
...
true ? TouchRipple.propTypes = {
   ...
   */
  center: import_prop_types31.default.bool,
  /**
   * Override or extend the styles applied to the component.
   */
...
var ButtonBase = React52.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
...
true ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  href: import_prop_types32.default.any,
  /**
   * The component used to render a link when the `href` prop is provided.
   * @default 'a'
   */
  LinkComponent: import_prop_types32.default.elementType,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onContextMenu: import_prop_types32.default.func,
  /**
   * @ignore
   */
  onDragLeave: import_prop_types32.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onMouseUp: import_prop_types32.default.func,
  /**
   * @ignore
   */
  onTouchEnd: import_prop_types32.default.func,
  /**
   * @ignore
   */
  onTouchMove: import_prop_types32.default.func,
  /**
   * @ignore
   */
  onTouchStart: import_prop_types32.default.func,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K4V4C5AO.js.map
